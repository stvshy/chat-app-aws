...
FRONTEND_TAG="v1.0.13"                 # Użyj tagu, który ostatnio przygotowywaliśmy
AUTH_SERVICE_TAG="v1.0.15"             # Przykładowy tag, zmień wg potrzeb
CHAT_SERVICE_TAG="v1.0.13"             # Przykładowy tag, zmień wg potrzeb
FILE_SERVICE_TAG="v1.0.13"             # Przykładowy tag, zmień wg potrzeb
NOTIFICATION_SERVICE_TAG="v1.0.13"     # Przykładowy tag, zmień wg potrzeb
