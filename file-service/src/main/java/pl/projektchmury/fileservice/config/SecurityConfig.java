    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/files/download/**").permitAll() // Pobieranie przez pre-signed URL
                        .requestMatchers(HttpMethod.GET, "/api/files/metadata/**").authenticated() // Dostęp do metadanych
